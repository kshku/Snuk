 ...
 */
SNUK_API bool snuk_memory_init(uint64_t reserve_size);
 ...
 */
SNUK_API void snuk_memory_deinit(void);
 ...
 */
SNUK_API void *snuk_allocate_pages(uint32_t pages);
 ...
 */
SNUK_API void snuk_free_pages(void *base, uint32_t pages);
 ...
 */
SNUK_API void *snuk_alloc(uint64_t size, uint64_t align);
 ...
 */
SNUK_API void *snuk_realloc(void *ptr, uint64_t new_size, uint64_t align);
