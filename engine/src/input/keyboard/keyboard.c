...
// Scancodes represents the physical keys and keycodes represent the virtual
// ones. So it mapping between both is not making sense. Mapping may be used for
// getting the expected scancode and expected keycode for given keycode and
// scancode respectivly.
...
//         || (sc >= SCANCODE_KEYPAD_COMMA && sc <=
//         SCANCODE_KEYPAD_EQUALS_AS400)
//         || (sc >= SCANCODE_ALTERASE && sc <= SCANCODE_RIGHT_GUI))
